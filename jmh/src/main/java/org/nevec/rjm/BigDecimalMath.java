...
public class BigDecimalMath {
     ...
     * precision in the argument. In particular this means that "Invalid
    ...
    static public BigDecimal powRound(final BigDecimal x, final BigInteger n) {
        /**
         * For now, the implementation forwards to the cases where n is in the
         * range of the standard integers. This might, however, be implemented
         * to decompose larger powers into cascaded calls to smaller ones.
         */
     ...
     * of integer exponents where the sign is carried over according to the
     ...
     * x+- xerr, as if the error was represented in a "half width" (half of the
     * error bar) form. The value is rounded down, and on the pessimistic side
     * for that reason.
     * @since 2009-05-30
     */
