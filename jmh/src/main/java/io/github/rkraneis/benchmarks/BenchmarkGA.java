...
public class BenchmarkGA {
	...
	/**
	 * This example shows the rather convoluted, but fun way to exploit JMH API
	 * in complex scenarios. Up to this point, we haven't consumed the results
	 * programmatically, and hence we are missing all the fun.
	 *
	 * Let's consider this naive code, which obviously suffers from the
	 * performance anomalies, since current HotSpot is resistant to make the
	...
	public static void main(String[] args) throws RunnerException {
		...
		Options baseOpts = new OptionsBuilder()
				.include(".*" + BenchmarkGA.class.getName() + ".*")
	...
	public static class Population {
		...
		/**
		 * Select the breeding material. Solutions with better score have better
